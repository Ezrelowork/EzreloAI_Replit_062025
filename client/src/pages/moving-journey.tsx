...
export default function MovingJourney() {
  ...
  const movingTasks: MovingTask[] = [
    ...
    },
    {
      ...
      completed: false,
      position: { x: "55%", y: "75%" }, // Below road, center-right
      icon: Zap
    },
    {
      id: "address-change",
      ...
      completed: false,
      position: { x: "38%", y: "48%" }, // Above road, center
      icon: FileText
    },
    {
      ...
      category: "Healthcare",
      completed: false,
      position: { x: "70%", y: "35%" }, // Below road, right side
      icon: Stethoscope
    },
    {
      ...
      category: "Family",
      completed: false,
      position: { x: "60%", y: "30%" }, // Above road, right side
      icon: GraduationCap
    }
  ];
