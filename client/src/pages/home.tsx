        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-blue-100">Personalized moving strategies based on your specific needs</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100">AI-curated service providers and cost optimization</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Conversational Assistant</h3>
              <p className="text-blue-100">Chat with AI throughout your moving journey for instant help</p>
            </div>
          </div>
        </div>
      </section>
