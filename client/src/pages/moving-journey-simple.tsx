      ...
      <div className="relative max-w-7xl mx-auto p-6 min-h-[600px] z-10">
        ...
        {journeyData.map((step, index) => {
          ...
          if (index === 0) {
            ...
            position = { left: '35%', top: '35%' };    // Third sign - address changes graphic
          } else {
            ...
            >
              ...
              <div className="relative group">
                <img 
                  src={customSign.src}
                  alt={customSign.alt}
                  className={`${index === 0 ? 'w-[26rem] h-[17rem]' : index === 2 ? 'w-96 h-64' : 'w-72 h-48'} object-contain transition-all duration-300 ${
